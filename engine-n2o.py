...
fr = (payload * 100) * ( 76000.00 + 9.80665) # force required in Newtons
...
ft = math.sqrt( ((2 * K ** 2) / (K-1)) * math.pow((2 / K + 1), (K+1 / K-1)) * (1 - math.pow (pe-pc, (K-1 / K))) ) + (pe + pa) * ae
